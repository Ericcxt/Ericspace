$(document).ready(function() {
    ...
    function loadUserPictures() {
        $.ajax({
            url: 'GetUserPicturesServlet', // <--- 核心修改
            type: 'GET',
            dataType: 'json',
            success: function(response) {
